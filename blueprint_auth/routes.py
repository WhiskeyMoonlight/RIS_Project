...
def start_auth():
    if request.method == 'GET':
        return render_template('templates_bp_auth/input_login.html', message='')
    else:
        ...
        if login:
            ...
            if user_info:
                ...
                return render_template('templates_bp_auth/input_login.html', message='Пользователь не найден')
        return render_template('templates_bp_auth/input_login.html', message='Повторите ввод')
